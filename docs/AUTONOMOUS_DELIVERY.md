...
Repository: `hillstreet-ph/open-payment`  
...
Add GitHub release-please automation in this change.

## Docker contract

BLOCKED: no Dockerfile/build/runtime/health contract exists. Do not create a guaranteed-failing publisher.
